...
{
    [FileLocation(nameof(FoxxyTestMod))]
    ...
    public class LocaleEN : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            {
                { m_Setting.GetSettingsLocaleID(), "FoxxyTestMod" },
                ...
                {
                    m_Setting.GetOptionDescLocaleID(nameof(Setting.Vector2BindingDown)),
                ...
                {
                    m_Setting.GetOptionDescLocaleID(nameof(Setting.Vector2BindingUp)),
                ...
                {
                    m_Setting.GetOptionDescLocaleID(nameof(Setting.Vector2BindingLeft)),
